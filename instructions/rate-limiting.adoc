...
take a look at link:http://github.com/thoraxe/istio-lab-summit-2019/blob/master/src/istiofiles/recommendation_rate_limit_handler.yml[recommendation_rate_limit_handler.yml]
...
[source,bash,subs="+macros,+attributes"]
----
$ oc -n istio-tutorial create -f http://github.com/thoraxe/istio-lab-summit-2019/blob/master/src/istiofiles/recommendation_rate_limit.yml
...
[source,bash,subs="+macros,+attributes"]
----
oc -n istio-tutorial delete -f http://github.com/thoraxe/istio-lab-summit-2019/blob/master/src/istiofiles/recommendation_rate_limit.yml
...
Istio provides a simple mechanism to dynamically limit the traffic to a particular service or version of a service.
