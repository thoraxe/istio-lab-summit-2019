...
[source,bash,subs="+macros,+attributes"]
----
$ bash <(curl -s https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/scripts/curl_customer.sh)customer => preference => recommendation v1 from '7f8755bb79-vjwq2': 5282
